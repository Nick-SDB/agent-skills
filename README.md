...
A portable collection of 18 Agent Skills with deterministic distributions for Codex, Claude Code, and Kimi Code CLI.
...
The three `cc-*` skills are Claude Code-specific. The fifteen general skills render for all three targets.
