...
A portable collection of 14 Agent Skills with deterministic distributions for Codex, Claude Code, and Kimi Code CLI.
...
The three `cc-*` skills are Claude Code-specific. The eleven general skills render for all three targets.
